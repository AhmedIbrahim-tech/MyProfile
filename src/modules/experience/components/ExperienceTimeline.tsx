...
import type { ExperienceRecord } from '@/modules/experience/types';
import '@/assets/styles/features/Experience.css';

export const ExperienceTimeline = () => {
  const getTechnologies = (exp: ExperienceRecord): string[] => {
  ...
  const currentExperience = profileData.experience.find((exp) =>
    exp.period.toLowerCase().includes('present')
  );
  const pastExperiences = profileData.experience.filter(
    ...
    <section className="experience" id="experience">
      <div className="experience-container">
        <h2 className="section-title">
          <i className="fas fa-briefcase"></i>
          <span>
            Explore My <strong>Experience</strong>
          </span>
        </h2>
