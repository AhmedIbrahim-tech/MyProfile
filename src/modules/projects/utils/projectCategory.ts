import type { Repository, TopProject, ProjectCategory } from "@/modules/projects/types";
...
export const getProjectCategory = (repo: Repository): ProjectCategory => {
  ...
  // ASP.NET Core MVC is inherently full-stack
  if (
    ...
    (description.includes("full-stack") ||
      ...
      description.includes("both frontend and backend"))
  ) {
    return "fullstack";
  }
